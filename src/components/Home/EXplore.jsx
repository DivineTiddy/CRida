...
const EXplore = () => {
  return (
    <div className=" w-[90%] h-auto max-[900px]:w-[95%]">
      <section className="flex justify-between items-end w-[100%] h-auto ">
        <div className="w-[25%] h-auto  max-[900px]:w-[40%]">
      ...
      <ul className="grid  grid-cols-3 gap-8 max-[900px]:gap-5  my-10  w-[100%] h-auto ">
        {items.map((item) => (
          <li
            key={item.name}
            className="flex flex-col justify-between  items-center bg-[#F5F5F5] w-[100%] h-[100%] "
          >
